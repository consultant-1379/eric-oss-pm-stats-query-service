...
*/ -}}
{{- define "eric-oss-pm-stats-query-service.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-oss-pm-stats-query-service.mergeAnnotations" -}}
  {{- include "eric-oss-pm-stats-query-service.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-oss-pm-stats-query-service.mergeLabels" -}}
  {{- include "eric-oss-pm-stats-query-service.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}