...
CMD ["/bin/sh", "-c", "java ${JAVA_OPTS} -Dcom.sun.management.jmxremote=true \
    ...
    -jar eric-oss-pm-stats-query-service-app.jar"]
...
LABEL \
    org.opencontainers.image.title=eric-oss-pm-stats-query-service-jsb \
    ...
    com.ericsson.product-3pp-name="Apache Olingo, OData4j" \
    com.ericsson.product-3pp-version="5.0.0"
